...
const documents = {
    ...
    "mutation AddRecipe($userInput: AddRecipeInput!) {\n  addRecipe(userInput: $userInput) {\n    recipeAdded\n    error\n  }\n}": types.AddRecipeDocument,
    ...
    "query UserRecipes($email: String!) {\n  userRecipes(email: $email) {\n    userRecipes {\n      name\n      upVotes\n      downVotes\n      savesCount\n    }\n    userRecipes {\n      name\n      cookingTime\n      difficulty\n      cookingSteps\n      upVotes\n      downVotes\n      savesCount\n      userId\n    }\n    error\n  }\n}\n\nquery UserRecipesCountAndStats($email: String!) {\n  userRecipesCountAndStats(email: $email) {\n    recipesCount\n    upVotes\n    downVotes\n    savesCount\n  }\n}": types.UserRecipesDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation AddRecipe($userInput: AddRecipeInput!) {\n  addRecipe(userInput: $userInput) {\n    recipeAdded\n    error\n  }\n}"): (typeof documents)["mutation AddRecipe($userInput: AddRecipeInput!) {\n  addRecipe(userInput: $userInput) {\n    recipeAdded\n    error\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
