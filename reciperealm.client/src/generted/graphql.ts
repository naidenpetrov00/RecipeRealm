...
export type ChangePictureMutation = {
  __typename?: "Mutation";
  changePicture: {
    __typename?: "ChangeProfilePicturePayload";
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "userProfilePicture" },
                },
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "emailSent" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "passwordChanged" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "errors" },
...
>;
export const ChangePictureDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "ChangePicture" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "ChangeProfilePictureInput" },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "profilePictureChanged" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "errors" },
  ...
  ChangePictureMutationVariables
>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "AddRecipeInput" },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "recipeAdded" } },
                { kind: "Field", name: { kind: "Name", value: "error" } },
              ],
            },
          },
...
export const CheckUsernameAvailabilityDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
export const UserRecipesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "UserRecipes" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "savesCount" },
                      },
                    ],
                  },
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "cookingTime" },
                      },
                      {
                        kind: "Field",
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "cookingSteps" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "upVotes" },
